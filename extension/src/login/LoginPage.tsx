...
export default function LoginPage({ onLoginSuccess }: LoginPageProps) {
  ...
  return (
    <div
      className="
        relative w-[380px] min-w-[360px] min-h-[560px] overflow-auto
        bg-gradient-to-br from-gray-950 to-[#052334]
        flex items-center justify-center p-4
        rounded-xl
      "
    >
      {/* decorative orbs + faint grid */}
      <div
        aria-hidden
        className="
          pointer-events-none absolute inset-0
          bg-[radial-gradient(900px_360px_at_80%_-20%,rgba(250,204,21,0.08),transparent),
              radial-gradient(700px_360px_at_-10%_0%,rgba(251,146,60,0.08),transparent),
      ...
      <div className="relative z-10 w-full max-w-[360px]">
        <div className="rounded-2xl border border-white/10 bg-white/10 p-4 shadow-2xl backdrop-blur-md">
          ...
          {/* title + subtitle */}
          <h1 className="mt-3 text-center text-2xl font-bold text-white/90">Welcome back</h1>
          <p className="mt-1 text-center text-sm text-gray-400">Practice smarter. Stay on track.</p>
